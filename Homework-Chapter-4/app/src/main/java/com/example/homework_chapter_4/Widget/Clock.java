package com.example.homework_chapter_4.Widget;
...
public class Clock extends View {
    ...
    //HourValues
    private Paint mHourValuesPaint;

    //ClockHandler
    private final int CLOCK_UPDATE = 100;
    ...
    private Handler clockHandler = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case CLOCK_UPDATE:
                    invalidate();
                    clockHandler.sendMessageDelayed(clockHandler.obtainMessage(CLOCK_UPDATE), 1000);
            }
        }
    };
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHourValuesPaint = new Paint();
        mHourValuesPaint.setTextAlign(Paint.Align.CENTER);
        mHourValuesPaint.setColor(Color.WHITE);
        mHourValuesPaint.setTextSize(50);
        mHourValuesPaint.setStyle(Paint.Style.FILL);

    }

    public void start(){
        message.what = CLOCK_UPDATE;
        clockHandler.sendMessageDelayed(message, 1 * 1000);
    }
    ...
    private void drawHoursValues(Canvas canvas) {
        ...
        for (int i = 1; i < 13; i++){
            float[] value_xy = getPointerHeadXY(PANEL_RADIUS * 0.7f , i * UNIT_DEGREE * 5);
            canvas.drawText(String.valueOf(i), value_xy[0], value_xy[1], mHourValuesPaint);
        }
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        drawPointer(canvas, 1, nowMinutes + nowSeconds / 60);
